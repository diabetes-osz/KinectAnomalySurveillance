...
#define PRIMARY_VIEW_MIN_WIDTH      240//960
#define PRIMARY_VIEW_MIN_HEIGHT     120//540
#define SECOND_VIEW_FIXED_WIDTH     960
#define SECOND_VIEW_FIXED_HEIGHT    540
#define TABBED_VIEW_FIXED_HEIGHT    240
#define TAB_CONTROL_FIXED_HEIGHT    25
#define GAP_BETWEEN_VIEWS           0
...
void KinectWindow::InitializeMenu()
{
    ...
    if (hMenu)
    {
        ...
        CheckMenuRadioItem(hMenu,
                             ...
                             ID_RESOLUTION_INFRAREDRESOLUTION640X480FPS30,
                             MF_BYCOMMAND);
        CheckMenuRadioItem(hMenu,
        ...
        CheckMenuRadioItem(hMenu,
                             ...
                             ID_DEPTHTREATMENT_DISPLAYALLDEPTHS,
                             MF_BYCOMMAND);
        CheckMenuRadioItem(hMenu,
